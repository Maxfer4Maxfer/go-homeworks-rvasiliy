...
go tool pprof -alloc_space -pdf mem.out > mem_alloc_space.pdf
go tool pprof -alloc_objects -pdf mem.out > mem_alloc_objects.pdf
go tool pprof -inuse_space -pdf mem.out > mem_inuse_space.pdf
go tool pprof -inuse_objects -pdf mem.out > mem_inuse_objects.pdf
